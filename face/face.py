...
import os
for dirname, _, filenames in os.walk('/./data_set/real_and_fake_face_detection/real_and_fake_face/'):
...
fakeDir='/./data_set/real_and_fake_face_detection/real_and_fake_face/training_fake/'
realDir='/./data_set/real_and_fake_face_detection/real_and_fake_face/training_real/'
...
fakeImgList=os.listdir('/./data_set/real_and_fake_face_detection/real_and_fake_face/training_fake/')
realImgList=os.listdir('/./data_set/real_and_fake_face_detection/real_and_fake_face/training_real/')
